package com.hannikkala.jsliferay.servlet.service;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import com.hannikkala.jsliferay.delegate.config.RequestConfig;
import com.hannikkala.jsliferay.delegate.config.RequestConfigList;
...
public class RequestConfigServiceImpl implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        String restResource = env.getProperty("jsportlet.rest.resource", "classpath:application.yml");
