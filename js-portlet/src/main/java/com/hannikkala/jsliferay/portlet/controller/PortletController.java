...
import com.hannikkala.jsliferay.service.WebsiteServiceImpl;
...
public class PortletController {
    ...
    public String index(RenderRequest request, RenderResponse response, Model model) {
        ...
        model.addAttribute("portletFriendlyUrl", PortalUtil.getCurrentURL(request));
        ...
        model.addAttribute("applicationRootUrl", root);
